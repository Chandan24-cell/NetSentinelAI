...
if df_list:
    ...
    # Optional: Save as compressed parquet for faster loading later
    # data.to_parquet("merged_cve_dataset.parquet", compression='snappy')
    # print(f"Also saved as parquet format for faster loading")
else:
